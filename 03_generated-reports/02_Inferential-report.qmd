...
```{r}
lmtest::coeftest(x = models$total_uni, vcov = sandwich::vcovHC)
```
...
```{r}
lmtest::coeftest(x = models$total_cat, vcov = sandwich::vcovHC)
```
...
```{r}
lmtest::coeftest(x = models$total_uni_cat, vcov = sandwich::vcovHC)
```
...
```{r}
lmtest::coeftest(x = models$pos_cat, vcov = sandwich::vcovHC)
```
...
```{r}
lmtest::coeftest(x = models$pos_uni_cat, vcov = sandwich::vcovHC)
...
```{r}
lmtest::coeftest(x = models$neg_cat, vcov = sandwich::vcovHC)
```
...
```{r}
lmtest::coeftest(x = models$neg_uni_cat, vcov = sandwich::vcovHC)
