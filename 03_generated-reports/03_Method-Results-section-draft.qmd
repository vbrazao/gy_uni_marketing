...
dat |> 
  ...
  labs(x = "", y = "", 
       caption = stringr::str_wrap("Note. Dotted line highlights Oct. 7, 2023. Each point represents one post. Points are arranged as a \"beeswarm\" to make it easier to see how many posts of the same category were published on the same day.", width = 80)) +
  theme(
